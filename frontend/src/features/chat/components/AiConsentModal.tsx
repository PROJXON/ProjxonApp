          ...
          <ScrollView style={styles.summaryScroll}>
            {isEncryptedChat ? (
              <>
                ...
                >
                  Also sent: display names, the conversation id for this chat, and, if you use AI
                  Helper with media, up to a few small image or video thumbnails (see our Privacy
                  Policy). Nothing is sent until you choose Continue.
                </Text>
              </>
            ) : (
              <>
                <Text style={[styles.summaryText, isDark ? styles.summaryTextDark : null]}>
                  ...
                  return a summary or suggested text.
                </Text>
                <Text
                  style={[
                    styles.summaryText,
                ...
                >
                  ...
                  you use AI Helper with media, small image or video thumbnails (see our Privacy
                  Policy). Nothing is sent until you tap Continue.
                </Text>
              </>
            )}
            <Text
            ...
            >
              {isEncryptedChat ? (
                <>
                  Tap Continue to send this request to OpenAI. Cancel skips for now. We will show
                  this again after you fully close and reopen the app.
                </>
              ) : (
                <>
                  Tap Continue to send this request to OpenAI. Cancel skips for now. We will not
                  show this again on this device unless you reinstall the app or clear its storage.
                </>
              )}
            </Text>
          </ScrollView>
